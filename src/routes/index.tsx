    ...
    >
      ...
      <div className="mt-10 flex items-center justify-center gap-4">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-6 py-3 text-sm font-medium text-foreground transition-all hover:-translate-y-0.5 hover:bg-hobby-design/40"
        >
          <Mail className="h-4 w-4" />
          yasmin295g@gmail.com
        </a>
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-6 py-3 text-sm font-medium text-foreground transition-all hover:-translate-y-0.5 hover:bg-hobby-code/40"
        >
      ...
      <p className="mt-16 text-xs text-muted-foreground">
        © {new Date().getFullYear()} Yasmin Greenholts · HIT — Holon Institute of Technology
      </p>
    </section>
  );
}
